...
.cell-item{display: flex; padding: 12px 15px;font-size: 15px;border-bottom: 1px solid #e4e4e4;position: relative}
.cell-item:after{content: '';display: block;position: absolute;width: 12px;height: 100%;background: url("../assets/images/arrow_icon.png") no-repeat center;background-size: 12px;top: 0;right: 15px}
</style>